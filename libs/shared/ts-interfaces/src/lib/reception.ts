 ...
 */
export type Reception = ReceptionPartial & ReceptionExtras;
/**
...
export type AggregatedCountriesOfOrigin = Country2[];
...
/**
 * The lots that were received.
 *
 * @minItems 0
 */
export type Lots = (LotPartial | CID)[];
...
export interface ReceptionExtras {
  lots: Lots;
}
/**
